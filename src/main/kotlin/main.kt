...
fun main() {
    ...
    if (rezultCommision == -1.0) {
        ...
        println("�������� � ����� $currentTransition �� ����� $cardType $rezultCommision ���.")

}

fun countCommision(cardType: String = "Vk_Pay", prevTransition: Double = 0.0, currentTransition: Double): Number {
...
fun countCommision(cardType: String, prevTransition: Double, currentTransition: Double): Double {
    ...
    var result = when (cardType) {
        ...
        "Visa", "���" -> if ((currentTransition / 100 * 0.75) < minCoast) minCoast else (currentTransition / 100 * 0.75)
